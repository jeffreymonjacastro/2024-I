...
class Token {
public:
  enum Type { LPAREN=0, RPAREN, PLUS, MINUS, MULT, DIV, POW, NUM, FLOAT, ID, SIN, COS, LOG, PI, IF, ERR, END };
...
const char* Token::token_names[17] = { "LPAREN" , "RPAREN", "PLUS", "MINUS", "MULT", "DIV", "POW", "NUM", "FLOAT", "ID", "SIN", "COS", "LOG", "PI", "IF", "ERR", "END" };
