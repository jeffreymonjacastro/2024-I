...
public:
  ...
  void save(ostringstream& str, string path);
};
...
void BinaryExp::genCode(ostringstream& str) {
  this->left->genCode(str);
  this->right->genCode(str);

  char c = binopToChar(this->op);

  switch (c) {
  case '+': str << "add" << endl; break;
  case '-': str << "sub" << endl; break;
  case '*': str << "mul" << endl; break;
  case '/': str << "div" << endl; break;
  default:
    break;
  }
}
...
void Exp::save(ostringstream& str, string path){
