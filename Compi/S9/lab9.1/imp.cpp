...
IfStatement::IfStatement(Exp *c, Body *tsl, Body *fsl) : cond(c), tsl(tsl), fsl(fsl) {}

WhileStatement::WhileStatement(Exp *c, Body *sl) : cond(c), sl(sl) {}
