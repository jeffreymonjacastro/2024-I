...
class Token {
public:
  enum Type { LPAREN=0, RPAREN, PLUS, MINUS, MULT, DIV, POW, FLOAT, ID, NUM, ERR, END };
...
const char* Token::token_names[12] = { "LPAREN" , "RPAREN", "PLUS", "MINUS", "MULT", "DIV", "POW", "FLOAT", "ID", "NUM", "ERR", "END" };
