...
{
      23,    -6,   -12,     0,     1,     3,    10,    12,    14,    66,
     -12,    30,    30,    30,    30,    30,   -12,    71,    30,    30,
      30,    30,   -12,    31,    38,    45,    52,    59,   -12,   -11,
...
{
      17,    20,    21,    23,    24,    25,    26,    27,    10,     0,
      29,    30,    31,    32,    16,    11,    12,     2,    13,     3,
       4,     5,     6,     7,     1,    14,     2,    15,     3,     4,
       5,     6,     7,     2,     0,     3,     4,     5,     6,     7,
       0,    18,    19,    20,    21,     0,     0,    33,    18,    19,
      20,    21,     0,     0,    34,    18,    19,    20,    21,     0,
       0,    35,    18,    19,    20,    21,     0,     0,    36,    18,
      19,    20,    21,     0,     0,    37,    18,    19,    20,    21,
      22,    18,    19,    20,    21,    28
};

static const yytype_int8 yycheck[] =
{
       8,    12,    13,    11,    12,    13,    14,    15,    14,    -1,
      18,    19,    20,    21,     0,    15,    15,     3,    15,     5,
       6,     7,     8,     9,     1,    15,     3,    15,     5,     6,
       7,     8,     9,     3,    -1,     5,     6,     7,     8,     9,
      -1,    10,    11,    12,    13,    -1,    -1,    16,    10,    11,
...
{
       0,     1,     3,     5,     6,     7,     8,     9,    18,    19,
      14,    15,    15,    15,    15,    15,     0,    19,    10,    11,
      12,    13,    14,    19,    19,    19,    19,    19,    14,    19,
...
#line 59 "grammar.y"
                               {
                                 (yyval.exp) = new Minus ((yyvsp[-2].exp), (yyvsp[0].exp));
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.pop ();  // take them of the allocated nodes stack.
                                 nodes.push ((yyval.exp));
                               }
...
#line 71 "grammar.y"
                               {
                                 (yyval.exp) = new Divide ((yyvsp[-2].exp), (yyvsp[0].exp));
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.pop ();  // take them of the allocated nodes stack.
                                 nodes.push ((yyval.exp));
                               }
...
#line 77 "grammar.y"
                               {
                                 (yyval.exp) = new Trigonometric ((yyvsp[-1].exp), 's');
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.push ((yyval.exp));
                               }
...
#line 82 "grammar.y"
                               {
                                 (yyval.exp) = new Trigonometric ((yyvsp[-1].exp), 'c');
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.push ((yyval.exp));
                               }
...
#line 87 "grammar.y"
                               {
                                 (yyval.exp) = new Trigonometric ((yyvsp[-1].exp), 't');
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.push ((yyval.exp));
                               }
...
#line 92 "grammar.y"
                               {
                                 (yyval.exp) = new Logarithm ((yyvsp[-1].exp), 'l');
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.push ((yyval.exp));
                               }
...
#line 97 "grammar.y"
                               {
                                 (yyval.exp) = new Logarithm ((yyvsp[-1].exp), 'e');
                                 nodes.pop ();  //  The childreen are handled by Plus so we
                                 nodes.push ((yyval.exp));
                               }
...
#line 102 "grammar.y"
                               { 
                                (yyval.exp) = new Number ((yyvsp[0].value)); 
                                nodes.push ((yyval.exp)); 
                                }
